...
//
//    @Test
//    @DisplayName("GET balance by id. Return the checking account balance based on id")
...
//
//        MvcResult mvcResult = mockMvc.perform( MockMvcRequestBuilders.get("/accounts/getbalance/checking/" + testAccount.getId()))
